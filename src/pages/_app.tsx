    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center text-slate-400 font-sans">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm font-medium tracking-wide">Initializing Core Engine...</span>
        </div>
      </div>
    );
  }

  const { Provider, store, QueryClientProvider, queryClient, AuthWrapper } = Providers;
